...
def departmentApi(request, id=0):
    if request.method == "GET":
        ...
        if departments_serializer.is_valid():
            ...
            return JsonResponse("Success to Post!", safe=False)

        else:
            return JsonResponse("Failed to Post!", safe=False)

    elif request.method == "PUT":
        department_data = JSONParser().parse(request)
        department = Departments.objects.get(
            DepartmentId=department_data.get("DepartmentId")
        )
        ...
        department.delete()
        return JsonResponse("Success to Delete!", safe=False)
